...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      "flex w-full h-9 items-center justify-between rounded-md border bg-transparent px-3 py-2",
      // Typography
      "whitespace-nowrap text-sm",
      // Visuals
      "border-input shadow-sm placeholder:text-muted-foreground",
      // Ring offset
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        // Animation states - slide direction
